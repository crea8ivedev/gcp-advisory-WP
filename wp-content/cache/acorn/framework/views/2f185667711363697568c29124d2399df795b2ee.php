<?php if(isset($content->hide_section) && $content->hide_section == 'no'): ?>
    ...
    <section class="general-content pt-20 pb-20 bg-white">
        <div class="container-fluid-lg">
            <?php if(!empty($content->logo)): ?>
                <div class="general-conent-icon mx-auto w-[60px] h-[60px] lg:w-[80px] lg:h-[80px] xl2:w-[120px] xl2:h-[120px]">
                    <img class="mx-auto img-fluid" src="<?php echo $content->logo['url']; ?>" alt="<?php echo $content->heading; ?>" width="120"
                        height="120">
                </div>
            <?php endif; ?>
    ...
    <?php if($blog_arr): ?>
        <section class="blog-grid-wrapper pt-20 pb-70 <?php if($content->extra_class): ?> <?php echo $content->extra_class; ?> <?php endif; ?>"
