            ...
            <div class="w-full lg:w-[70%] xl2:w-[62.5%]">
                <div class="flex justify-between items-start gap-[20px]">
                    <div class="menu-wrapper hidden lg:block">
                        <?php if(!empty($footer_first_menu_title)): ?>
                            <div class="menu-title title-white title-nunito">
                                <h4><?php echo $footer_first_menu_title; ?></h4>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="menu-wrapper hidden lg:block">
                        <?php if(!empty($footer_second_menu_title)): ?>
                            <div class="menu-title title-white title-nunito">
                                <h4><?php echo $footer_second_menu_title; ?></h4>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="menu-wrapper hidden lg:block">
                        <?php if(!empty($footer_third_menu_title)): ?>
                            <div class="menu-title title-white title-nunito">
                                <h4><?php echo $footer_third_menu_title; ?></h4>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="mobile-footer-menu lg:hidden block w-full">
                        <ul>
                            <li class="toggle-submenu">
                                <?php if(!empty($footer_first_menu_title)): ?>
                                    <a href="javascript:void(0)"
                                        class="relative z-1 block w-full"><?php echo $footer_first_menu_title; ?></a>
                                <?php endif; ?>
                                <img src="<?= \Roots\asset('images/bottom-arrow.png'); ?>" alt="arrow" class="arrow right-0 top-10 absolute lozad">
                                <?php if(has_nav_menu('Footer_menu_one')): ?>
                                    <?php echo wp_nav_menu([
                                        'theme_location' => 'Footer_menu_one',
                            ...
                            <li class="toggle-submenu">
                                <?php if(!empty($footer_second_menu_title)): ?>
                                    <a href="javascript:void(0)"
                                        class="relative z-1 block w-full"><?php echo $footer_second_menu_title; ?></a>
                                <?php endif; ?>
                                <img src="<?= \Roots\asset('images/bottom-arrow.png'); ?>" alt="arrow" class="arrow right-0 top-10 absolute lozad">
                                <?php if(has_nav_menu('Footer_menu_two')): ?>
                                    <?php echo wp_nav_menu([
                            ...
                            <li class="toggle-submenu border-0 border-b-2 border-solid pb-20">
                                <?php if(!empty($footer_third_menu_title)): ?>
                                    <a href="javascript:void(0)"
                                        class="relative z-1 block w-full"><?php echo $footer_third_menu_title; ?></a>
                                <?php endif; ?>
                                <img src="<?= \Roots\asset('images/bottom-arrow.png'); ?>" alt="arrow" class="arrow right-0 top-10 absolute lozad">
                                <?php if(has_nav_menu('Footer_menu_three')): ?>
                                    <?php echo wp_nav_menu([
                ...
                <div
                    ...
                    <?php if(!empty($phone)): ?>
                        <div class="contact-info flex items-center gap-[10px]">
                            <img src="<?= \Roots\asset('images/call-icon.png'); ?>" alt="call-icon" width="16" height="16">
                            <a class="relative" href="<?php echo $phone['url']; ?>">
                    ...
                    <?php if(!empty($copyright_text)): ?>
                        <div class="copyright-text">
                            <p>© <?php echo e(date('Y')); ?> <?php echo e($copyright_text); ?></p>
                        </div>
                    <?php endif; ?>
                        ...
                        <?php if(!empty($footer_social_media)): ?>
                            <div class="linkedin-icon">
                                <div class="social-icon flex items-center gap-[10px]">
                                    <?php $__currentLoopData = $footer_social_media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="flex" href="<?php echo $social_media['social_media_link']; ?>" target="_blank">
                                        <img src="<?php echo $social_media['social_media_icon']['url']; ?>" alt="<?php echo $social_media['social_media_icon']['alt']; ?>" width="40"
...
<?php /**PATH E:\xampp8\htdocs\ts\gcp-advisory-WP\wp-content\themes\gcp-advisory\resources\views/sections/footer.blade.php ENDPATH**/ ?>