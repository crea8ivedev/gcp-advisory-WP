<?php if(isset($content->hide_section) && $content->hide_section == 'no'): ?>
                    ...
                    <?php if(!empty($content->image)): ?>
                        <div class="w-full lg:w-[55%]">
                            <div class="zigzag-img relative pt-[54%] h-full fadeText">
                                <img class="img-ratio lozad" src="<?php echo $content->image['url']; ?>"
                                    alt="<?php echo $content->image['alt']; ?>" width="644" height="424">
                            </div>
                        </div>
                    <?php endif; ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH E:\xampp8\htdocs\ts\gcp-advisory-WP\wp-content\themes\gcp-advisory\resources\views/partials/sections/industry/image_with_content.blade.php ENDPATH**/ ?>