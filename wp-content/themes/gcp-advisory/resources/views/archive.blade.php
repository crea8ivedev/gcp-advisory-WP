...
@section('content')
        ...
        <div class="banner-cta relative z-1 h-full">
            <div class="container-fluid-lg h-full">
                <div class="content text-center h-full">
                    <div
                        class="slider-content h-full flex justify-center lg:justify-end items-center flex-col pt-[150px] pb-[100px] xl2:pt-120 xl2:pb-[130px]">
    ...
    @if ($blog_arr)
        <section class="blog-grid-wrapper pt-20 pb-40 xl2:pb-70 ">
                                ...
                                @if ($blog_details['fea_img'])
                                    <a href="{!! $blog_details['url'] !!}">
                                        <img class="img-fluid" src="{!! $blog_details['fea_img'] !!}"
                                            class="w-full h-full object-cover" alt="{!! $blog_details['title'] !!}" width="360.67"
                                            height="260">
                                    </a>
                                @else
                                    <a href="{!! $blog_details['url'] !!}">
