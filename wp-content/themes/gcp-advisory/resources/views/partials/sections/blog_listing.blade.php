@if (isset($content->hide_section) && $content->hide_section == 'no')
        ...
        <div class="container-fluid-lg">
            @if (!empty($content->logo))
                <div class="general-conent-icon mx-auto w-[60px] h-[60px] lg:w-[80px] lg:h-[80px] xl2:w-[120px] xl2:h-[120px]">
                    <img class="mx-auto img-fluid" src="{!! $content->logo['url'] !!}" alt="{!! $content->heading !!}" width="120"
                        height="120">
                </div>
            @endif
    ...
    @if ($blog_arr)
        <section class="blog-grid-wrapper pt-20 pb-70 @if ($content->extra_class) {!! $content->extra_class !!} @endif"
